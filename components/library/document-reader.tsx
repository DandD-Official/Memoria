...
export function DocumentReader({ content, kind, next, resolvedAssets, related = [] }: { content: string; kind: "note" | "reviewer"; next?: React.ReactNode; resolvedAssets?: Record<string, string | null>; related?: RelatedMaterial[] }) {
