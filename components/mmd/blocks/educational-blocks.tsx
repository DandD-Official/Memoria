...
export function KeyConceptBlock({ children }: { children: ReactNode }) {
  return (
    <aside className="my-5 rounded-card border border-accent/25 border-s-4 border-s-accent bg-accent-soft/30 p-5 shadow-sm">
...
export function ExampleBlock({ node, children }: { node: MmdBlockNode; children: ReactNode }) {
  return (
    <article className="my-5 rounded-card border border-line bg-ink/[0.025] p-5 shadow-sm">
...
export function ImportantBlock({ children }: { children: ReactNode }) {
  return (
    <aside className="my-5 rounded-card border border-danger/25 border-s-4 border-s-danger bg-danger/[0.05] p-5 shadow-sm">
...
export function SummaryBlock({ children }: { children: ReactNode }) {
  return (
    <section className="my-5 rounded-card border border-line bg-ink/[0.03] p-5">
