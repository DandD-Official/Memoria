...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: <>
      ...
      <p>Memoria follows the <a href="https://developers.google.com/terms/api-services-user-data-policy">Google API Services User Data Policy</a>, including its Limited Use requirements. Google data is used to provide the features you request, not for advertising, sale to data brokers, credit decisions, or training generalized AI models. Human access is limited to your permission, necessary security investigations, or legal obligations.</p>
    </>,
  },
  {
