...
export default function LandingPage() {
  return <div className="landing-journal">
    ...
    <footer className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-5 border-t border-line px-page py-7"><Brand /><p className="text-xs text-ink-faint">A place for knowledge to become yours.</p><nav aria-label="Footer" className="flex flex-wrap gap-x-5 text-xs"><Link href="/privacy-policy" className="min-h-11 py-3 hover:underline">Privacy policy</Link><Link href="/terms-of-service" className="min-h-11 py-3 hover:underline">Terms of service</Link><Link href="/login" className="min-h-11 py-3 hover:underline">Log in</Link><Link href="/register" className="min-h-11 py-3 hover:underline">Create an account</Link></nav></footer>
  </div>;
}
